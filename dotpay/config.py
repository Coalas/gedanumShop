...
PAYMENT_GROUP = ConfigurationGroup('PAYMENT_DOTPAY',
    _('DOTPAY (ServiRed) Payment Module Settings'))
...
config_register_list(
    ModuleValue(PAYMENT_GROUP,
        ...
        hidden=True,
        default = 'payment.modules.dotpay'
        ),
    ...
    StringValue(PAYMENT_GROUP,
        ...
        default = 'Credit Card (via DOTPAY)',
        dummy = _('Credit Card (via DOTPAY)'), # Force this to appear on po-files
    ...
    StringValue(
        ...
        default='DOTPAY_satchmo_checkout-notify_callback',
        ordering=300
        ),
    StringValue(
        PAYMENT_GROUP,
        ...
        default='DOTPAY_satchmo_checkout-success',
        ordering=310
        ),
    StringValue(
        PAYMENT_GROUP,
        ...
        default='DOTPAY_satchmo_checkout-failure',
        ordering=320
        ),
